...
[~,~,~]=mkdir("Q_Tail_Fit/All_Tail_2_9_2_1_Q_from_IV/Moneyness");
[~,~,~]=mkdir("Q_Tail_Fit/All_Tail_2_9_2_1_Q_from_IV/Return");
[~,~,~]=mkdir("Q_Tail_Fit/All_Tail_2_9_2_1_Q_from_IV/Output");
[~,~,~]=mkdir("Q_Tail_Fit/All_Tail_2_9_2_1_Q_from_IV/Return/Raw_density");
[~,~,~]=mkdir("Q_Tail_Fit/All_Tail_2_9_2_1_Q_from_IV/Return/Fit_process");
[~,~,~]=mkdir("Q_Tail_Fit/All_Tail_2_9_2_1_Q_from_IV/Return/Full_tail");
[~,~,~]=mkdir("Q_Tail_Fit/All_Tail_2_9_2_1_Q_from_IV/Return/Full_tail_with_color");
[~,~,~]=mkdir("Q_Tail_Fit/All_Tail_2_9_2_1_Q_from_IV/Moneyness/Raw_density");
[~,~,~]=mkdir("Q_Tail_Fit/All_Tail_2_9_2_1_Q_from_IV/Moneyness/Fit_process");
[~,~,~]=mkdir("Q_Tail_Fit/All_Tail_2_9_2_1_Q_from_IV/Moneyness/Full_tail");
[~,~,~]=mkdir("Q_Tail_Fit/All_Tail_2_9_2_1_Q_from_IV/Moneyness/Full_tail_with_color");
[~,~,~]=mkdir("Q_Tail_Fit/All_Tail_2_9_2_1_Q_from_IV/GIF");
[~,~,~]=mkdir("Q_Tail_Fit/All_Tail_2_9_2_1_Q_from_IV/Q_matrix");
[~,~,~]=mkdir("Q_Tail_Fit/All_Tail_2_9_2_1_Q_from_IV/paras");
[~,~,~]=mkdir("Q_Tail_Fit/All_Tail_2_9_2_1_Q_from_IV/probability_matrix");
[~,~,~]=mkdir("Q_Tail_Fit/All_Tail_2_9_2_1_Q_from_IV/cutoff");
...
dates_list([0, 6, 11, 12, 13, 14, 15, 20, 21, 23, 24, 25, 26, 27, 28, 29, 30, 33, 34, 38, 43, 45, 51, 78]+1)=[];
...
%         data_q.cdf_m,'Initial_paras_left',[0.3128,0.0456, 0.0296],'IR',interest_rate);
    ...
    saveas(gcf,strcat('Q_Tail_Fit/All_Tail_2_9_2_1_Q_from_IV/Return/Raw_density/Raw_density_',date,'.png'))
    ...
    ylim([0, 9])
    xticks(min(rt):0.2:max(rt))
    saveas(gcf,strcat('Q_Tail_Fit/All_Tail_2_9_2_1_Q_from_IV/Return/Fit_process/Fit_process_',date,'.png'))
    ...
    xlim([min(rt), max(rt)])
    xticks(min(rt):0.2:max(rt))
    saveas(gcf,strcat('Q_Tail_Fit/All_Tail_2_9_2_1_Q_from_IV/Return/Full_tail/Full_tail_',date,'.png'))
    ...
    xlim([min(rt), max(rt)])
    xticks(min(rt):0.2:max(rt))
    saveas(gcf,strcat('Q_Tail_Fit/All_Tail_2_9_2_1_Q_from_IV/Return/Full_tail_with_color/Show_tail_',date,'.png'))

    % write Q density
    output = table(rt', Q_rt','VariableNames',{'Return', 'Q_density'});
    writetable(output,strcat('Q_Tail_Fit/All_Tail_2_9_2_1_Q_from_IV/Output/Q_density_logreturn_',date,'.csv'))

end

outputtable = array2table(cutoffs,"VariableNames",{'left','right'});
writetable(outputtable,'Q_Tail_Fit/All_Tail_2_9_2_1_Q_from_IV/cutoff/cutoff.csv')
outputtable = array2table(Q_matrix,"VariableNames",string(dates_list));
writetable(outputtable,'Q_Tail_Fit/All_Tail_2_9_2_1_Q_from_IV/Q_matrix/Q_matrix.csv')
outputtable = array2table(paras_r,"VariableNames",{'xi','b','a'});
writetable(outputtable,'Q_Tail_Fit/All_Tail_2_9_2_1_Q_from_IV/paras/paras_right.csv')
outputtable = array2table(paras_l,"VariableNames",{'xi','b','a'});
writetable(outputtable,'Q_Tail_Fit/All_Tail_2_9_2_1_Q_from_IV/paras/paras_left.csv')
outputtable = array2table(probability_matrix,"VariableNames",string(dates_list));
writetable(outputtable,'Q_Tail_Fit/All_Tail_2_9_2_1_Q_from_IV/probability_matrix/probability_matrix.csv')
...
%% probability matrix
probability_matrix=table2array(readtable('Q_Tail_Fit/All_Tail_2_9_2_1_Q_from_IV/probability_matrix/probability_matrix.csv','ReadVariableNames',true));
...
saveas(gcf,'Q_Tail_Fit/All_Tail_2_9_2_1_Q_from_IV/probability_matrix/3parts.png')
%% probability with cutoff
cutoffs=table2array(readtable('Q_Tail_Fit/All_Tail_2_9_2_1_Q_from_IV/cutoff/cutoff.csv','ReadVariableNames',true));
x=datetime(dates_list,"Format","MMMyyyy");
y=probability_matrix(1:3,:)';
...
saveas(gcf,'Q_Tail_Fit/All_Tail_2_9_2_1_Q_from_IV/probability_matrix/3parts_with_cutoff.png')
%% Parameters matrix
paras_l=table2array(readtable('Q_Tail_Fit/All_Tail_2_9_2_1_Q_from_IV/paras/paras_left.csv','ReadVariableNames',true));
...
paras_r=table2array(readtable('Q_Tail_Fit/All_Tail_2_9_2_1_Q_from_IV/paras/paras_right.csv','ReadVariableNames',true));
paras_report=nan(5,3);
...
saveas(gcf,'Q_Tail_Fit/All_Tail_2_9_2_1_Q_from_IV/paras/coefficients.png')
...
saveas(gcf,'Q_Tail_Fit/All_Tail_2_9_2_1_Q_from_IV/paras/coefficients_with_problematic.png')
...
for i = 1:numel(dates_list)
    date = datestr(dates_list(i),'yyyy-mm-dd');
    a = strcat('Q_Tail_Fit/All_Tail_2_8_2_3_Q_from_IV/Output/Q_density_logreturn_',date,'.csv');
    Q_table = readtable(a);
    writetable(Q_table,strcat('Q_Tail_Fit/All_Tail_2_9_2_1_Q_from_IV/Output/Q_density_logreturn_',date,'.csv'))
end