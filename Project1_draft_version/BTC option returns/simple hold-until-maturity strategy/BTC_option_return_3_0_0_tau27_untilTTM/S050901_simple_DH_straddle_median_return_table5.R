...
prepare_summary_EW <- function(summary_table) {
  selected_columns <- summary_table[, c("Equally_Average")]
  return(as.data.frame(t(selected_columns),row.names = c("EW")))
}
prepare_summary_VW <- function(summary_table) {
  selected_columns <- summary_table[, c("Weighted_Average", "Num_obs")]
  return(as.data.frame(t(selected_columns),row.names = c("VW", "Num_obs")))
}

prepared_simple_longStraddle_EW_overall <- prepare_summary_EW(summaries_simple_longStraddle_overall_EW)
prepared_simple_longStraddle_VW_overall <- prepare_summary_VW(summaries_simple_longStraddle_overall_VW)
...
prepared_DH_longStraddle_EW_overall <- prepare_summary_EW(summaries_DH_longStraddle_overall_EW)
prepared_DH_longStraddle_VW_overall <- prepare_summary_VW(summaries_DH_longStraddle_overall_VW)
...
prepared_simple_longStraddle_EW_cluster0 <- prepare_summary_EW(summaries_simple_longStraddle_cluster0_EW)
prepared_simple_longStraddle_VW_cluster0 <- prepare_summary_VW(summaries_simple_longStraddle_cluster0_VW)
...
prepared_DH_longStraddle_EW_cluster0 <- prepare_summary_EW(summaries_DH_longStraddle_cluster0_EW)
prepared_DH_longStraddle_VW_cluster0 <- prepare_summary_VW(summaries_DH_longStraddle_cluster0_VW)
...
prepared_simple_longStraddle_EW_cluster1 <- prepare_summary_EW(summaries_simple_longStraddle_cluster1_EW)
prepared_simple_longStraddle_VW_cluster1 <- prepare_summary_VW(summaries_simple_longStraddle_cluster1_VW)
...
prepared_DH_longStraddle_EW_cluster1 <- prepare_summary_EW(summaries_DH_longStraddle_cluster1_EW)
prepared_DH_longStraddle_VW_cluster1 <- prepare_summary_VW(summaries_DH_longStraddle_cluster1_VW)
