...
# In this file, we calculate simple strategy ATM call and put returns
...
setwd("~/Documents/GitHub/BTC-premia/Project1_draft_version/BTC option returns/simple hold-until-maturity strategy/BTC_option_return_3_0_1_tau27_untilTTM/")
...
write_csv(summaries_longcall_cluster0[dim(summaries_longcall_overall)[1]:-1:1,],paste0(new_dir,"longcall_cluster0_0d35_0d65.csv"))
write_csv(summaries_longput_cluster0,paste0(new_dir,"longput_cluster0_0d35_0d65.csv"))
write_csv(summaries_longcall_cluster1[dim(summaries_longcall_overall)[1]:-1:1,],paste0(new_dir,"longcall_cluster1_0d35_0d65.csv"))
write_csv(summaries_longput_cluster1,paste0(new_dir,"longput_cluster1_0d35_0d65.csv"))
write_csv(summaries_longcall_overall[dim(summaries_longcall_overall)[1]:-1:1,],paste0(new_dir,"longcall_overall_0d35_0d65.csv"))
write_csv(summaries_longput_overall,paste0(new_dir,"longput_overall_0d35_0d65.csv"))
