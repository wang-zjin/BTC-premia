...
% Load sample returns
RR_OA = readtable("Bitcoin_Premium/2_1_X_13/505_sample_return_OA.xlsx");
RR_c0 = readtable("Bitcoin_Premium/2_1_X_13/505_sample_return_HV.xlsx");
RR_c1 = readtable("Bitcoin_Premium/2_1_X_13/505_sample_return_LV.xlsx");
