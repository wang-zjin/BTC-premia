%% This file reports the Variance Risk Prremium (VRP) table in our main text

% The original file in folder "matlab_code_for_BTC" is named 
% "BTC_1_12_3_1_2_reporttable_VRP_Qdensity_VIX_RV_1.m", which reorganize
