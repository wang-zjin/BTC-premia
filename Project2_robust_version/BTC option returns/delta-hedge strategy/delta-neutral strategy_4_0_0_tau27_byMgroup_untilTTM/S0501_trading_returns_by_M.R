...
# for (f in 1:nrow(files)){
  ...
  longStraddle_by_m = read_csv(paste0("S03_trading_returns/DH_",trading_type,"Straddle_by_M_tttm",
                                      as.character(ttm),".csv"))
  ...
  ggsave(filename = paste0(new_dir,trading_type,"DH_by_m_ttm",as.character(ttm),".png"), plot = by_m_plt_long, bg = "transparent", width = 22, height = 10, dpi = 300)
