...
weight_type = files$weight[f]


longStraddle_by_m = read_csv(paste0("S03_trading_returns/DH_",trading_type,"Straddle_by_M_",weight_type,"_ttm",
...
cluster_colors <- c("Long Call DH" = "blue", "Long Put DH" = "blue", "Long Straddle DH" = "blue")
...
# Save the plot
ggsave(filename = paste0(new_dir,trading_type,"DH_",weight_type,"_ttm",as.character(ttm),"_",as.character(cluster),".png"), plot = plt_HV, bg = "transparent", width = 14, height = 7, dpi = 300)

#### LV Cluster ####
cluster = "Cluster1"
dat_cluster <- filter(dat_by_m, Cluster == cluster)
# Define colors based on the cluster
cluster_colors <- c("Long Call DH" = "red", "Long Put DH" = "red", "Long Straddle DH" = "red")
...
# Save the plot
ggsave(filename = paste0(new_dir,trading_type,"DH_",weight_type,"_ttm",as.character(ttm),"_",as.character(cluster),".png"), plot = plt_LV, bg = "transparent", width = 14, height = 7, dpi = 300)
...
# Define colors based on the cluster
cluster_colors <- c("Long Call DH" = "black", "Long Put DH" = "black", "Long Straddle DH" = "black")
...
# Save the plot
ggsave(filename = paste0(new_dir,trading_type,"DH_",weight_type,"_ttm",as.character(ttm),"_",as.character(cluster),".png"), plot = plt_OA, bg = "transparent", width = 14, height = 7, dpi = 300)
...
ggsave(filename = paste0(new_dir, trading_type, "_DH_",weight_type,"_combined_ttm", as.character(ttm), ".png"), plot = combined_plot, width = 14, height = 21, dpi = 300)
