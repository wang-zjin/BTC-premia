...
write_csv(summaries_longStraddle_cluster0_EW,paste0(new_dir,"longstraddle_cluster0_EW_0d2.csv"))
write_csv(summaries_longStraddle_cluster0_VW,paste0(new_dir,"longstraddle_cluster0_VW_0d2.csv"))
write_csv(summaries_longStraddle_cluster1_EW,paste0(new_dir,"longstraddle_cluster1_EW_0d2.csv"))
write_csv(summaries_longStraddle_cluster1_VW,paste0(new_dir,"longstraddle_cluster1_VW_0d2.csv"))
write_csv(summaries_longStraddle_overall_EW,paste0(new_dir,"longstraddle_overall_EW_0d2.csv"))
write_csv(summaries_longStraddle_overall_VW,paste0(new_dir,"longstraddle_overall_VW_0d2.csv"))
