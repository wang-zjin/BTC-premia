...
# for (f in 1:nrow(files)){
  ...
  write_csv(EW_straddle_returns,paste0("S03_trading_returns/simple_LongStraddle_by_M_EW_ttm",as.character(ttm),".csv"))
  
  write_csv(VW_straddle_returns,paste0("S03_trading_returns/simple_LongStraddle_by_M_VW_ttm",as.character(ttm),".csv"))
