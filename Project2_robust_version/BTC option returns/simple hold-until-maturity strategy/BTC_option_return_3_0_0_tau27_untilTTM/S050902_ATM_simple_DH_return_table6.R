...
simple_callput_dir = "BTC option return/BTC_option_return_3_0_0_tau27_untilTTM/S050502_ATM_result/"
simple_straddle_dir = "BTC option return/BTC_option_return_3_0_0_tau27_untilTTM/S050701_ATM_result/"
DH_callput_dir = "delta-neutral strategy/delta-neutral strategy_4_0_0_tau27_byMgroup_untilTTM/S050501_ATM_result/"
DH_straddle_dir = "delta-neutral strategy/delta-neutral strategy_4_0_0_tau27_byMgroup_untilTTM/S050601_ATM_result/"
new_dir = "BTC option return/BTC_option_return_3_0_0_tau27_untilTTM/S050502_ATM_result/"
...
prepare_table6 = function(ATM_def){
  ...
  tb_overall <- c(summaries_simple_longcall_overall$Equally_Average[3],summaries_simple_longput_overall$Equally_Average[3],summaries_simple_longStraddle_overall$Equally_Average[3])
  tb_cluster0 <- c(summaries_simple_longcall_cluster0$Equally_Average[3],summaries_simple_longput_cluster0$Equally_Average[3],summaries_simple_longStraddle_cluster0$Equally_Average[3])
  tb_cluster1 <- c(summaries_simple_longcall_cluster1$Equally_Average[3],summaries_simple_longput_cluster1$Equally_Average[3],summaries_simple_longStraddle_cluster1$Equally_Average[3])
  tb_simple <- rbind(tb_overall,tb_cluster0,tb_cluster1)
  
  tb_overall <- c(summaries_DH_longcall_overall$Equally_Average[3],summaries_DH_longput_overall$Equally_Average[3],summaries_DH_longStraddle_overall$Equally_Average[3])
  tb_cluster0 <- c(summaries_DH_longcall_cluster0$Equally_Average[3],summaries_DH_longput_cluster0$Equally_Average[3],summaries_DH_longStraddle_cluster0$Equally_Average[3])
  tb_cluster1 <- c(summaries_DH_longcall_cluster1$Equally_Average[3],summaries_DH_longput_cluster1$Equally_Average[3],summaries_DH_longStraddle_cluster1$Equally_Average[3])
