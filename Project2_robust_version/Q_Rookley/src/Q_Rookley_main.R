...
bootstrap_epk = function(f, ts, currdate, out_dir, bandwidth, mon_low, mon_up){
  ...
  # doublecheck = cbind(log(mon.grid.scaled), sigmas[,1], sigmas[,2]/(mon.max-mon.min), sigmas[,3]/(mon.max-mon.min)^2)
  # print(doublecheck)
  # print(sigmas[,2]/(mon.max-mon.min))
  # print(sigmas[,3]/(mon.max-mon.min)^2)
