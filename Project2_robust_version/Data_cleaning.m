...
clear,clc
option_sorted = readtable("data/17Jul_18Dec/sampleall.csv");           % Scrabed by Raul 
option2 = readtable("data/deribit20192020/option1920clean.csv"); % Scrabed by Raul 
option3 = readtable("data/all_btc33.csv");                       % Scrabed by Julia

% Notice there is an overlapping period between Raul and Julia data
% Remove Julia data before 2021 from the third dataset to avoid overlap
option3(option3.date < datetime("2021-01-01"), :) = [];
option3(option3.date >= datetime("2022-10-01"), :) = [];

option = [option_sorted;option2;option3];
clear option_sorted option2 option3
