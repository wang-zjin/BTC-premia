...
common_dates = readtable('Clustering/Tau-independent/unique/moneyness_step_0d01/multivariate_clustering/common_dates_cluster.csv');
...
saveas(gcf, "Clustering/Tau-independent/unique/moneyness_step_0d01/multivariate_clustering/sideview.png")