...
#df1 = df1.drop(['20180610', '20181118'], axis=1)
...
# Initialize a list to hold the concatenated vectors
...
# Calculate the pairwise multivariate Euclidean distances between the rows of this new matrix
