...
BP_overall_ttm27=readtable("RiskPremia/moneyness/Bitcoin_Premium/BP_SCA_ePDF_backward_onlyVR_OA_differentNB_ttm27.xlsx");
BP_c0_ttm27=readtable("RiskPremia/moneyness/Bitcoin_Premium/BP_SCA_ePDF_backward_onlyVR_HV_differentNB_ttm27.xlsx");
BP_c1_ttm27=readtable("RiskPremia/moneyness/Bitcoin_Premium/BP_SCA_ePDF_backward_onlyVR_LV_differentNB_ttm27.xlsx");
...
info.cnames = strvcat('BP(-0.2)-BP(-0.6)','|int_pk|','|int_pk|/0.4','BP(0.6)-BP(0.2)','|int_pk|','|int_pk|/0.4');
info.fmt    = '%10.3f';
disp('Influential return state table')
mprint(Influential_return_state_table,info)
