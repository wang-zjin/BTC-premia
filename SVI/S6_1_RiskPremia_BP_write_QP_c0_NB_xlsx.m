...
Q_average = Q_density_average(dates_Q{1,1},ttm);

trapz(ret, Q_average)

% forward and backward return
return_overall = Simple_return_fullsample_overlapping(daily_price,ttm);
return_overall = rescale_shift_return_exp(return_overall,0,0,2.840,3.377,ttm);
...
writetable(outtable, "RiskPremia/moneyness/Bitcoin_Premium/BP_SCA_ePDF_backward_onlyVR_HV_differentNB_ttm27.xlsx")
