...
writetable(tb_VIX_RV_VRP_cluster0,"RiskPremia/moneyness/Variance_Risk_Premium/VRP_VIX_logRV_HV.csv");
writetable(tb_VIX_RV_VRP_cluster1,"RiskPremia/moneyness/Variance_Risk_Premium/VRP_VIX_logRV_LV.csv");