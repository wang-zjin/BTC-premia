...
saveas(gcf,"RiskPremia/moneyness/Bitcoin_Premium/BP_SCA_ePDF_backward_onlyVR_OA_NB12_1by1_plot.png")
...
ax.XAxis.LineWidth = 1; % Increase the line width of the Y-axis
% sgtitle(strcat('BP, full sample overlapping empirical PDF by rescaled returns'),'FontSize',30)
saveas(gcf,"RiskPremia/moneyness/Bitcoin_Premium/BP_SCA_ePDF_backward_onlyVR_HV_NB12_1by1_plot.png")
...
ax.XAxis.LineWidth = 1; % Increase the line width of the Y-axis
% sgtitle(strcat('BP, full sample overlapping empirical PDF by rescaled returns'),'FontSize',30)
saveas(gcf,"RiskPremia/moneyness/Bitcoin_Premium/BP_SCA_ePDF_backward_onlyVR_LV_NB12_1by1_plot.png")
...
ax.XAxis.LineWidth = 1; % Increase the line width of the Y-axis
% sgtitle(strcat('BP, full sample overlapping empirical PDF by rescaled returns'),'FontSize',30)
saveas(gcf,"RiskPremia/moneyness/Bitcoin_Premium/BP_SCA_ePDF_backward_onlyVR_OAHVLV_NB12_1by1_plot.png")
