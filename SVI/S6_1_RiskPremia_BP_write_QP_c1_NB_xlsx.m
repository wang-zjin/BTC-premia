...
return_overall = rescale_shift_return_exp(return_overall,0,0,2.840,2.289,ttm);
...
writetable(outtable, "RiskPremia/moneyness/Bitcoin_Premium/BP_SCA_ePDF_backward_onlyVR_LV_differentNB_ttm27.xlsx")
...
writetable(outtable, "RiskPremia/moneyness/Bitcoin_Premium/Q_P_ePDF_backward_onlyVR_LV_differentNB_ttm27.xlsx")
