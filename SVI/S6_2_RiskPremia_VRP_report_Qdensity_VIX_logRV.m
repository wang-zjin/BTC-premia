...
clc,clear
tb_Qdensity_RV_VRP_cluster0 = readtable("RiskPremia/moneyness/Variance_Risk_Premium/VRP_Qdensity_logRV_HV.csv");
tb_Qdensity_RV_VRP_cluster1 = readtable("RiskPremia/moneyness/Variance_Risk_Premium/VRP_Qdensity_logRV_LV.csv");
tb_Qdensity_RV_VRP_overall = [tb_Qdensity_RV_VRP_cluster0;tb_Qdensity_RV_VRP_cluster1];
tb_VIX_RV_VRP_cluster0 = readtable("RiskPremia/moneyness/Variance_Risk_Premium/VRP_VIX_logRV_HV.csv");
tb_VIX_RV_VRP_cluster1 = readtable("RiskPremia/moneyness/Variance_Risk_Premium/VRP_VIX_logRV_LV.csv");
...
cluster_label_1_VIX = [repmat("cluster_0",height(tb_VIX_RV_VRP_cluster1),1);repmat("overall",height(tb_VIX_RV_VRP_overall),1)];
% Q: Q density vs VIX
