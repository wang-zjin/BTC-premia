...
def process_csv_file(filename):
    ...
    # Now you can get the predicted IV for ttm=9 using the SVI model
    iv_svi_at_9 = np.sqrt(svi_model(best_thetas, k_new, 5) / 5)
...
#df_thetas.to_csv('paras27.csv', index=True)
#results_df.to_csv('svi_iv_and_r2_results27.csv', index=False)
