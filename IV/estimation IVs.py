...
path="/Users/ratmir/Downloads/testttm/update/IR0" # TODO: Ist richtig.
#path="/Users/ratmir/Downloads/testttm/IV_matrix_IR0" # TODO: Ist richtig.

os.chdir(path)
#read data:
df1 = pd.read_csv('svi_iv_and_r2_results5.csv') # TODO: Ist richtig.
df2 = pd.read_csv('paras5.csv') # TODO: Ist richtig.

#C1 = pd.read_csv('dates_cluster1.csv') # TODO: Ist richtig.
#C0 = pd.read_csv('dates_cluster0.csv') # TODO: Ist richtig.
...
for ttm in ttms:
    ...
    for file in paras['Date']:
        ...
        #if str(ttm) not in file_df.columns:
